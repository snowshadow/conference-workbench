...
for(const file of ['.gitignore','.env.example','README.md','CONTRIBUTING.md','SECURITY.md','docs/SCREENSHOTS.md','docs/assets/cover.svg','docs/assets/workflow.svg','docs/assets/screenshot-focus.png','docs/assets/screenshot-topics.png','docs/assets/screenshot-transcript.png','LICENSE','NOTICE.md','docs/GETTING_STARTED.md','skills/meeting-workbench/SKILL.md']) if(!existsSync(file))throw new Error(`缺少 ${file}`);
